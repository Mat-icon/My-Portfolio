        ...
        <div className="w-full h-auto px-10 md:px-0 ">
          ...
          <div className="flex flex-col xl:ml-[22%] mt-0 xl:mt-[1%] tracking-tighter md:items-center md:flex-row md:space-x-2">
            ...
            <Link
              ...
              className="w-10/12 material-bubble2 md:w-full lg:w-3/12 p-4 lg:px-4 rounded-md border-[#000] border text-center text-sm"
            ...
            <Link
              ...
              style={{ background: "#1D242A" }}
              target="_blank"
              className="w-10/12 mt-1 md:mt-0 material-bubble3 md:w-full lg:w-3/12 p-4 lg:px-4 rounded-md border-[#000] bg-black border text-center text-sm"
              onMouseOver={(e) => e.currentTarget.style.borderColor = accentColor}
              onMouseOut={(e) => e.currentTarget.style.borderColor = "#000"}
            >
              {hoveredBtn2 ? (
