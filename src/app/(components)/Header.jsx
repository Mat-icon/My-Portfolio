...
const Header = () => {
  return (
    <div className="relative z-10 flex flex-col text-center items-center mt-16 md:mt-24">
      <span className="text-xs md:text-[13px] poppins mb-3 md:mb-6 text-gray-400 uppercase tracking-wider">
        Home
      </span>
      ...
      <p className="w-10/12 md:w-10/12 lg:w-5/12 2xl:w-6/12 tracking-tighter md:text-[16px] text-[14px] text-center max-w-2xl text-gray-400 mt-4 md:mt-8 our-text">
