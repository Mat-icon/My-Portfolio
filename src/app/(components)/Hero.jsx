  ...
  return (
    ...
    >
      ...
      <header className="flex justify-between filter glossy-25 backdrop-blur-2xl items-center h-10 pr-2 border-b border-[#6462628c] shrink-0">
        <div className="flex w-[12%] border-r border-[#494949] md:w-[3.15%] h-full justify-center items-center group overflow-hidden">
          <div className="rotate-90 gap-[1px] flex items-center transition-transform duration-500 ease-in-out group-hover:rotate-[450deg]">
            ...
            />
            <span 
              className="w-1 h-3 bg-white rotate-[30deg] rounded-full animate-none group-hover:animate-crazy2"
            />
            <span 
              className="w-2 h-2 border-t-4 border-r-4 border-white rotate-[45deg] animate-none group-hover:animate-crazy3"
            />
          </div>
        </div>
        ...
        <div className="flex text-lg items-center">
          <span className="tracking-tighter font-medium text-center fonts">
            matthew
            <span style={{ color: accentColor }}>&#123;ameh&#125;</span>
          </span>
        </div>
      ...
      <div className="flex flex-1 min-h-0 relative">
        {/* Sidebar */}
        <aside className="hidden md:flex md:flex-col md:items-center tracking-tight glossy-25 backdrop-blur-2xl md:justify-center md:space-y-2 md:border-r md:border-[#6462628c] md:w-[3.1%] md:absolute md:left-0 md:top-0 md:bottom-0 md:z-10">
          <div className="icon-container">
            <button onClick={() => navigateTo("/")}>
              <FiHome
                ...
                onMouseLeave={(e) => e.currentTarget.style.color = currentRoute === "/" ? "white" : "#c5c4c4"}
              />
            </button>
          ...
          <div className="icon-container">
            <button onClick={() => navigateTo("/projects")}>
              <AiOutlineLaptop
                ...
                onMouseEnter={(e) => e.currentTarget.style.color = accentColor}
                onMouseLeave={(e) => e.currentTarget.style.color = currentRoute === "/projects" ? "white" : "#9D9D9D"}
              />
            </button>
          ...
          <div className="icon-container">
            <button onClick={() => navigateTo("/about")}>
              <FiUser
                ...
                onMouseEnter={(e) => e.currentTarget.style.color = accentColor}
                onMouseLeave={(e) => e.currentTarget.style.color = currentRoute === "/about" ? "white" : "#9D9D9D"}
              />
            </button>
          ...
          <div className="icon-container">
            <button onClick={() => navigateTo("/contact")}>
              <FiMail
                ...
                onMouseEnter={(e) => e.currentTarget.style.color = accentColor}
                onMouseLeave={(e) => e.currentTarget.style.color = currentRoute === "/contact" ? "white" : "#9D9D9D"}
              />
            </button>
