      ...
      <div className="tech2 w-10/12 sm:w-11/12 md:w-7/12 lg:w-6/12 xl:9/12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 p-6 flex flex-col md:ml-10">
          ...
          <button
            type="submit"
            style={{ background: "#101010d3" }}
            className="material-bubble w-full md:w-7/12 lg:w-6/12 p-4 lg:px-4 rounded-md border border-gray-600 text-center text-sm flex items-center justify-center"
          >
